...
if __name__ == '__main__':
    korbank_url = "http://ecos.bok.or.kr/api/StatisticSearch/{}/json/kr/1/50000/036Y005/MM/201401/202103/0000027" \
        .format(api_key)
    ...
    collection_exchange_rate_yuan_dollar = db_market_index['exchange_rate_yuan_dollar']
    ...
    insert_data = collection_exchange_rate_yuan_dollar.insert_many(rows_for_insert)
