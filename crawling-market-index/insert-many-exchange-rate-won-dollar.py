...
if __name__ == '__main__':
    korbank_url = "http://ecos.bok.or.kr/api/StatisticSearch/{}/json/kr/1/50000/036Y004/MM/201901/202103/0000001" \
        .format(api_key)
    ...
    collection_exchange_rate_won_dollar = db_market_index['exchange_rate_won_dollar']
    ...
    insert_data = collection_exchange_rate_won_dollar.insert_many(rows_for_insert)
