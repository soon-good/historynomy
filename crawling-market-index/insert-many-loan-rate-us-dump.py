...
if __name__ == '__main__':
    korbank_url = "http://ecos.bok.or.kr/api/StatisticSearch/{}/json/kr/1/50000/I10Y014/MM/19600101/20201231/US" \
        .format(api_key)
    ...
    collection_loan_rate_us = db_market_index['loan_rate_us']
    ...
    insert_data = collection_loan_rate_us.insert_many(rows_for_insert)
